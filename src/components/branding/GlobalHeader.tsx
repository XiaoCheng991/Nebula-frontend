...
const GlobalHeader: React.FC<GlobalHeaderProps> = ({
 ...
 <button className="flex items-center gap-1 px-2 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
 {getThemeIcon()}
 ...
 align="end"
 sideOffset={8}
 className="w-36 rounded-2xl bg-white dark:bg-gray-900 shadow-2xl backdrop-blur-xl p-2 !border-0"
 >
 <DropdownMenuItem
 onClick={() => setTheme('light')}
 className={`flex items-center gap-3 cursor-pointer rounded-xl py-2.5 px-3 transition-all mb-1 ${
 theme === 'light'
 ...
 className={`flex items-center gap-3 cursor-pointer rounded-xl py-2.5 px-3 transition-all ${
 theme === 'system'
 ? 'bg-gradient-to-r from-orange-500 to-amber-500 text-white'
 : 'hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-200'
 }`}
