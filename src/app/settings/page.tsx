      ...
      <CardContent>
       <div className="flex items-center gap-6">
        <div className="relative">
         ...
         />
         <label htmlFor="settings-avatar-upload" className="absolute bottom-0 right-0 bg-orange-500 rounded-full p-1.5 cursor-pointer hover:bg-orange-600 transition-colors">
