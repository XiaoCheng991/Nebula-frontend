...
const socialLinks = [
  ...
  { icon: LinkIcon, href: "https://example.com", label: "Website" },
];
              ...
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-4 min-w-0 flex-1">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <div>
                      <div className={`font-bold text-sm ${profiles[1].color}`}>
                        {profiles[1].name}
                      </div>
                      <div className="text-xs text-zinc-400 dark:text-zinc-500">
                        {profiles[1].bio}
                      ...
                      <div className="flex items-center gap-2.5 mt-0.5">
                        <span className="text-xs text-zinc-500 dark:text-zinc-400">
                          <span className="font-semibold">{profiles[1].stats.skills}</span> 技能
                        </span>
                        <span className="text-xs text-zinc-500 dark:text-zinc-400">
                          <span className="font-semibold">{profiles[1].stats.projects}</span> 项目
                        </span>
                      </div>
                    </div>
                  </div>
